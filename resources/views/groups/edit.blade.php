...
{!! Form::model($group, ['id' => 'group_form', 'method' => 'PATCH','route' => ['groups.update', $group->id]]) !!}
       ...
       <div class="block-content block-content-full">
            <div class="row">
                <div class="col-lg-6 space-y-2">
                    ...
                    <input type="text" class="form-control" maxlength="250" name="name" value="{{ $group->group_name }}">
                </div>
                <div class="col-lg-6 space-y-2">
