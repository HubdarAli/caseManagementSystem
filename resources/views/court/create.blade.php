    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">Add Court</h3>
            </div>
            <div class="block-content block-content-full">
                <form class="g-3 align-items-center" id="add-form" action="{{ route('court.store') }}" method="POST">
                    @csrf
                    <div class="row p-1">
                        <div class="col-6 mt-3">
                            <label class="form-label" for="name">Court Name</label><span class="text-danger">*</span>
                            <input type="text" class="form-control" id="name" name="name"
                                   placeholder="Enter Court Name" value="{{ old('name') }}">
                        </div>
