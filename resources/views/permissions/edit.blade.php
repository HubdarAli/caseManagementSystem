                    ...
                    <div class="row p-1">
                        <div class="col-6 mt-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                placeholder="Permission Name" value="{{ $permission->name }}" maxlength="250">
                        </div>
                        <div class="col-6 mt-3">
                            ...
                            <input type="text" class="form-control" id="permission_link" name="permission_link" readonly
                                placeholder="Permission Link" value="{{ $permission->permission_link }}" maxlength="250">
                        </div>
                        <div class="col-6 mt-3">
                        ...
                        <div class="col-6 mt-3">
                            ...
                            <input type="text" class="form-control" id="icon_name" name="icon_name"
                                placeholder="Icon Name" value="{{ $permission->icon_name }}" maxlength="250">
                        </div>
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <textarea name="description" class="form-control" id="description" rows="1" maxlength="250">{{ $permission->description }}</textarea>
                        </div>
                        <div class="col-6 mt-3">
