                ...
                {!! Form::open(['route' => ['users.update', $user->id], 'method' => 'PATCH', 'id' => 'user_form']) !!}
                    ...
                    <div class="row g-3">
                        <div class="col-4">
                            ...
                            <input type="text" name="name"class="form-control" placeholder="Name" value="{{ $user->name }}" maxlength="250">
                        ...
                        <div class="col-4">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="Email"
                                autocomplete="off" value="{{ $user->email }}" maxlength="250"/>
                        ...
                        <div class="col-4" id="smp_data">
                            ...
                            <select name="smp_id" class="form-control select select2" id="smp_id">
                        ...
                        <div class="col-4" id="district_data">
                            ...
                            <select name="district_id" class="form-control select2" id="district_id" multiple>
                            </select>
                        </div>
