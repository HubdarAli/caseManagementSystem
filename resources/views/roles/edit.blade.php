            ...
            <div class="block block-rounded">
                ...
                <div class="block-content block-content-full">
                    <div class="row">
                        ...
                        <div class="col-lg-6 space-y-2">
                            <label class="form-label">
                                Role Name <strong style="color:red">*</strong>
                            </label>
                            <input type="text" name="name" class="form-control" placeholder="Name"
                                value="{{ old('name', $role->name) }}" maxlength="250">
                            @error('name')
                        ...
                        <div class="col-lg-6 space-y-2">
                            ...
                            <select name="group_id" id="group_id"
                                class="form-control js-example-basic-single select select2">
                                <option value="">Choose Group</option>
                                @foreach ($groups as $group)
                                    <option value="{{ $group->id }}"
                                        {{ old('group_id', $role->group_id) == $group->id ? 'selected' : '' }}>
                                        {{ $group->group_name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row" id="permissionsContainer">
                        <!-- Inject dynamic permissions here -->
                    </div>
                ...
                success: function(response) {
                    ...
                    $.each(response, function(index, permission) {
                        ...
                        permissionsHtml += '<td><label class="form-check-label">' + permission.name +
                            '</label></td>';
                        permissionsHtml += '<td><input type="checkbox" name="permission[]" id="' +
                        ...
                        $.each(permission.subMenus, function(index1, permission1) {
                            ...
                            permissionsHtml +=
                                `<td class="${permission1.permission_type == 'menu' ? 'parent-with-permissions' : 'child-label'}">${permission1.name}</td>`;
